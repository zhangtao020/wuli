 ...
 */
public class GlobalListAdapter extends RecyclerView.Adapter{
    ...
    public GlobalListAdapter(List<PGlobalBean.GlobalBean> data, int width){
        this.data = data;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if(viewType == TYPE_ITEM){
            View view = LayoutInflater.from(mContext).inflate(R.layout.item_golbal_list,null);
