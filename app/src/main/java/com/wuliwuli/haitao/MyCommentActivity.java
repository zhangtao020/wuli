...
import com.wuliwuli.haitao.adapter.CommentAdapter;
...
public class MyCommentActivity extends AppBaseActivity{
    ...
    public void onViewCreated() {
        ...
        adapter = new CommentAdapter(null, AppApplication.DISPLAY_WIDTH);
    ...
    public void requestOrderData(){
        ...
        NormalPostRequest request = new NormalPostRequest(UrlManager.MY_COMMEND,
                new Response.Listener<PCommentBean>() {
                    @Override
                    public void onResponse(PCommentBean response) {
