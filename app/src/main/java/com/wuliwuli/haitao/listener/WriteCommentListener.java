 ...
 */
public class WriteCommentListener extends AppBaseListener{

    TextView likeTv;
    ProductBean productBean;

    public WriteCommentListener(Context context, TextView like, ProductBean bean){
        ...
        NormalPostRequest request = new NormalPostRequest(UrlManager.USER_LIKE,
                new Response.Listener<PTopicBean>() {
                    ...
                    public void onResponse(PTopicBean response) {
                        ...
                        likeTv.setSelected(productBean.is_liked == 1?true:false);
